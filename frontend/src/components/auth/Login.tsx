    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-ayur-50 to-emerald-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Welcome to AyurSutra</h2>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-1 gap-2 text-xs text-gray-600">
              <div className="bg-gray-50 p-2 rounded">
                <strong>Patient:</strong> patient@ayursutra.com / password123
              </div>
              <div className="bg-gray-50 p-2 rounded">
                <strong>Practitioner:</strong> practitioner@ayursutra.com / password123
              </div>
              <div className="bg-gray-50 p-2 rounded">
                <strong>Admin:</strong> admin@ayursutra.com / password123
              </div>
            </div>
          </div>
