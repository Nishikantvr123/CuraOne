  ...
  const mockPatients = [
    {
      ...
      gender: 'male',
      address: { street: '12 MG Road', city: 'Mumbai', state: 'Maharashtra', zipCode: '400001', country: 'India' },
      constitution: 'vata',
      currentImbalance: 'Excess vata causing anxiety and digestive issues',
      treatmentGoals: 'Reduce stress and improve sleep quality',
      practitionerNotes: 'Responds well to grounding practices.',
      preferredPractitioner: 'dr-aman-verma',
      lastVisit: '2024-01-15T10:00:00Z',
      nextAppointment: '2024-02-15T14:00:00Z',
      status: 'active',
      medicalHistory: 'History of anxiety, chronic fatigue',
      currentMedications: [{ name: 'Ashwagandha', dosage: '300mg', frequency: 'Twice daily', notes: 'With meals' }],
      allergies: [{ allergen: 'Shellfish', reaction: 'Hives', severity: 'moderate' }],
      emergencyContact: { name: 'Sunita Sharma', relationship: 'Mother', phone: '+91-98765-11111', email: 'sunita@email.com' }
    },
    {
      id: 2,
      firstName: 'Priya',
      ...
      gender: 'female',
      address: { street: '45 Nehru Nagar', city: 'Ahmedabad', state: 'Gujarat', zipCode: '380001', country: 'India' },
      constitution: 'pitta',
      ...
      practitionerNotes: 'Good compliance with diet changes.',
      preferredPractitioner: 'dr-aman-verma',
      lastVisit: '2024-01-10T09:30:00Z',
      nextAppointment: '2024-02-10T11:00:00Z',
      status: 'active',
      medicalHistory: 'Acid reflux, mild hypertension',
      currentMedications: [{ name: 'Amlaki', dosage: '500mg', frequency: 'Three times daily', notes: 'Before meals' }],
      allergies: [],
      emergencyContact: { name: 'Ravi Patel', relationship: 'Husband', phone: '+91-91234-99999', email: 'ravi@email.com' }
    },
    {
      id: 3,
      firstName: 'Arjun',
      ...
      gender: 'male',
      address: { street: '78 Sector 21', city: 'Chandigarh', state: 'Punjab', zipCode: '160021', country: 'India' },
      constitution: 'kapha',
      currentImbalance: 'Kapha excess causing weight gain and lethargy',
      treatmentGoals: 'Increase metabolism, improve energy levels',
      practitionerNotes: 'Started exercise routine. Needs stimulating herbs.',
      preferredPractitioner: 'dr-aman-verma',
      lastVisit: '2024-01-20T15:00:00Z',
      nextAppointment: null,
      status: 'inactive',
      medicalHistory: 'Mild hypothyroidism',
      currentMedications: [{ name: 'Guggulu', dosage: '250mg', frequency: 'Twice daily', notes: 'With warm water' }],
      allergies: [{ allergen: 'Peanuts', reaction: 'Anaphylaxis', severity: 'life-threatening' }],
      emergencyContact: { name: 'Harpreet Singh', relationship: 'Father', phone: '+91-99887-00001', email: 'harpreet@email.com' }
    }
  ];
  ...
  useEffect(() => {
    ...
    const loadPatients = async () => {
      ...
      try {
        ...
        // Only show toast once, silently fail if API unavailable
        setPatients([]);
        setFilteredPatients([]);
      } finally {
