...
interface DoctorSidebarProps {
  activeView: 'patients' | 'grants' | 'copilot';
  onSelectView: (view: 'patients' | 'grants' | 'copilot') => void;
  onOpenNewVisit?: () => void;
    ...
    <aside className="w-72 shrink-0 border-r border-border/60 bg-background/50 flex flex-col justify-between p-4 min-h-[calc(100vh-4rem)]">
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          {/* New Clinical Visit (Active if patient selected, else prompt) */}
          <button
            type="button"
            onClick={() => {
            ...
            title={!isPatientSelected ? 'Select a patient first to record an encounter' : 'Record new encounter'}
