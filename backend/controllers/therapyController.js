...
export const getAllTherapies = async (req, res, next) => {
  try {
    ...
    const therapies = await find('therapies', query);
...
export const getTherapiesByCategory = async (req, res, next) => {
  try {
    ...
    const therapies = await find('therapies', {
      category: category,
      isActive: true
    });
...
export const getTherapyById = async (req, res, next) => {
  try {
    const therapy = await findOne('therapies', { id: req.params.id });
...
export const createTherapy = async (req, res, next) => {
  try {
    ...
    const therapy = await create('therapies', {
      name,
...
export const updateTherapy = async (req, res, next) => {
  try {
    ...
    const updatedTherapy = await update('therapies', req.params.id, updateData);
...
export const deleteTherapy = async (req, res, next) => {
  try {
    ...
    const updatedTherapy = await update('therapies', req.params.id, {
      isActive: false,
