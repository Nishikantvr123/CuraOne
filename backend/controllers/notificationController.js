...
export const getNotificationById = async (req, res, next) => {
  try {
    const notification = await findOne('notifications', {
      id: req.params.id,
...
export const markAsRead = async (req, res, next) => {
  try {
    const notification = await serviceMarkAsRead(req.params.id, req.user.id);
...
export const markAllAsRead = async (req, res, next) => {
  try {
    const notifications = await serviceMarkAllAsRead(req.user.id);
...
export const deleteNotification = async (req, res, next) => {
  try {
    const notification = await serviceDeleteNotification(req.params.id, req.user.id);
...
export const getNotificationStats = async (req, res, next) => {
  try {
    const stats = await serviceGetNotificationStats();
